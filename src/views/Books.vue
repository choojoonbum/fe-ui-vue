    ...
    <div class="bookpage">
      ...
      <section class="bookdetail">
        ...
        <div class="book-detailinfo">
          <div class="detailTap">
            <b-form-radio name="detail-tap" v-model="tapselect" value="introduce" button button-variant="detailtap"><i class="bi bi-mic"/>책 소개</b-form-radio>
            <b-form-radio name="detail-tap" v-model="tapselect" value="review" button button-variant="detailtap"><i class="bi bi-chat-left-text"/>출판사 리뷰</b-form-radio>
            ...
            <b-form-radio name="detail-tap" v-model="tapselect" value="write" button button-variant="detailtap"><i class="bi bi-journal-text"/>저자 소개</b-form-radio>
            <b-form-radio name="detail-tap" v-model="tapselect" value="recommendation" button button-variant="detailtap"><i class="bi bi-person-check"/>추천의 글</b-form-radio>
          ...
          <template v-if="tapselect === 'introduce'">
            <div class="detailTapCon">
              ...
              <p>
                웹 어워드 코리아에서 대상, 최우수상을 수상한 현직 웹 퍼블리셔의 작업 방식 그대로 <br> 웹 사이트 하나 통째로 만들면
                나도 어느새 웹 퍼블리셔!!<br>이 책 한 권이면 웹 사이트 하나가 뚝딱 완성
              </p>
            </div>
          </template>
          <template v-else-if="tapselect === 'review'">
            <div class="detailTapCon">
              <h1 class="tapcontit"><strong>"Do it! 웹 사이트 따라 만들기"</strong>출판사 리뷰 입니다.</h1>
              <p>
          ...
          <template v-else-if="tapselect === 'recommendation'">
            <div class="detailTapCon">
              <h1 class="tapcontit"><strong>"Do it! 웹 사이트 따라 만들기"</strong>추천의 글 입니다.</h1>
              <p>
...
export default {
  ...
  data() {
    return {
      ...
      settings: {
        slidesToShow: 8,  //슬라이드 개수
        arrows: true,   // 버튼 사용 여부
        dots: false,    // 하단 버튼 사용 여부
        infinite: true,   // 슬라이드 반복 여부
        responsive: [
          {
            breakpoint: 1023, // 브라우저 크기가 767 이하일때
            settings: {
              slidesToShow: 5,
            },
          },
          {
            breakpoint: 767, // 브라우저 크기가 414 이하일때
            settings: {
              slidesToShow: 2,
            }
          }
      ...
      bookinfolists: [
        ...
        {label: "ISBN", content: "979-11-6303-119-2 1300"},
        {label: "상태", content: "16,000원"},
        {label: "정가", content: "정상판매중"},
      ],
      tapselect: "introduce",
    }
  }
