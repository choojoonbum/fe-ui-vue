<template>
  <section class="maincontents">
    <section class="mainbanner"><img src="/images/mainimg.png" alt=""/></section>
...
export default {
  data() {
    return {
      ...
      settings: {
        slidesToShow: 5,  //슬라이드 개수
        arrows: true,   // 버튼 사용 여부
        dots: false,    // 하단 버튼 사용 여부
        infinite: true,   // 슬라이드 반복 여부
        responsive: [
          {
            breakpoint: 767, // 브라우저 크기가 767 이하일때
            settings: {
              slidesToShow: 4,
            },
          },
          {
            breakpoint: 414, // 브라우저 크기가 414 이하일때
            settings: {
              slidesToShow: 2,
            }
          }
  ...
  methods: {
    ...
    viewmore(event) {
      ...
      if (classList.value.indexOf("full") > -1) {
